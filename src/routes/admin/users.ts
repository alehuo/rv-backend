...
import * as userStore from '../../db/userStore';
import * as historyStore from '../../db/historyStore';
const logger = require('../../logger').default;

router.use(authMiddleware('ADMIN', process.env.JWT_ADMIN_SECRET));

router.param('userId', async (req: any, res: any, next: any) => {
...
router.get('/:userId(\\d+)', async (req: any, res: any) => {
...
router.post('/:userId(\\d+)/changeRole', async (req: any, res: any) => {
...
router.get('/:userId(\\d+)/purchaseHistory', async (req: any, res: any) => {
...
router.get('/:userId(\\d+)/depositHistory', async (req: any, res: any) => {

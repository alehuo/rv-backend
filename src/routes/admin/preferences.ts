...
import { preferences, getPreference, setPreference, getPreferenceByKey } from '../../db/preferences';
...
router.get('/:preferenceKey', async (req: any, res: any) => {
...
router.patch('/:preferenceKey', async (req: any, res: any) => {
    const preference = getPreferenceByKey(req.params.preferenceKey);

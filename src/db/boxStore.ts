 ...
 */
export const findByBoxBarcode = async (boxBarcode: any) => {
 ...
 */
export const insertBox = async (boxData: any) => {
...
export const updateBox = async (boxBarcode: any, boxData: any) => {
    return await knex.transaction(async (trx: any) => {
...
export const deleteBox = async (boxBarcode: any) => {
    return await knex.transaction(async (trx: any) => {
...
export const buyIn = async (boxBarcode: any, boxCount: any) => {
    return await knex.transaction(async (trx: any) => {
        const row = await knex('RVBOX')
            .transacting(trx)
            .leftJoin('PRICE', 'RVBOX.itembarcode', 'PRICE.barcode')

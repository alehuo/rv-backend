 ...
 */
export const findByBarcode = async (barcode: any) => {
 ...
 */
export const updateProduct = async (barcode: any, productData: any, userId: any) => {
 ...
 */
export const recordPurchase = async (barcode: any, userId: any, count: any) => {
    return await knex.transaction(async (trx: any) => {
        const now = new Date();
...
export const deleteProduct = async (barcode: any) => {
    return await knex.transaction(async (trx: any) => {
        const row = await knex('PRICE')
            .leftJoin('RVITEM', 'PRICE.itemid', 'RVITEM.itemid')
            .leftJoin('PRODGROUP', 'RVITEM.pgrpid', 'PRODGROUP.pgrpid')
...
export const buyIn = async (barcode: any, count: any) => {
